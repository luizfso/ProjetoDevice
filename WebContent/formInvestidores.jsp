...
<html lang="en">
  <head>
    ...
    <title>Project PET Device - Cadastro Investidores</title>
	...
	<div class="jumbotron">
		...
		<div class="form-group">
    		<label for="inputName" class="col-sm-2 control-label">Nome</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="txtNome" id="inputName" placeholder="Nome Completo" value="${investidores.nome}"/>
    			</div>
  		</div>
		...
		<div class="form-group">
    		<label for="inputEmail3" class="col-sm-2 control-label">Email</label>
    			<div class="col-sm-10">
     			 <input type="email" class="form-control" name="txtEmail" id="inputEmail" placeholder="Email de Contato" value="${investidores.email}">
    			</div>
  		</div>
  		...
  		<div class="form-group">
    		<label for="inputName" class="col-sm-2 control-label">Telefone</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="txtTelefone" id="inputTelefone" placeholder="Telefone" value="${investidores.telefone}"/>
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputName" class="col-sm-2 control-label">Endereco</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="txtEndereco" id="inputTelefone" placeholder="Endereco de entrega" value="${investidores.endereco}"/>
    			</div>
  		</div>
  		
       <div class="form-group">
    		
		<a class="btn btn-primary" role="button" href="./home.jsp"><span class="glyphicon glyphicon-arrow-left"></span> Voltar</a>
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="About.jsp" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
