...
<html lang="en">
  <head>
	...
	<title>Project PET Device - Listar Investidores</title>
  ...
  <body>
    <div class="container">
      ...
      <table class="table table-striped"><!--  width="900px" align="center"> -->
            <thead>
		...
		<p><a class="btn btn-primary" role="button" href="menuInvest.jsp"><span class="glyphicon glyphicon-arrow-left"></span> Voltar</a> </p>
