...
<html lang="en">
  <head>
	...
	<title>Project PET Device - Listar Clientes</title>
    ...
    <div class="container">
      ...
      <h1>Lista de Clientes</h1>
       ...
       <table class="table table-striped"><!--  width="900px" align="center"> -->
		...
		<p><a class="btn btn-primary" role="button" href="menuCli.jsp"><span class="glyphicon glyphicon-arrow-left"></span> Voltar</a> </p>
